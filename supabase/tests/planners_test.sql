...
SELECT is(
    (SELECT count(*) FROM planners WHERE profile_id = '00000000-0000-0000-0000-000000000000' AND title = 'default'),
    1::bigint,
    'should have record with valid profile_id after creation of profiles'
);
